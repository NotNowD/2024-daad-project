...
# Збереження результатів PCA в таблицю
pca_data <- data.frame(PC1 = pca$x[,1], PC2 = pca$x[,2], condition = colData_new$condition)

# Візуалізація PCA за допомогою ggplot2
...
plotPCA(vsd, intgroup = "condition") + 
  labs(title = "PCA of Gene Expression Data (VST Transformed)")
```
